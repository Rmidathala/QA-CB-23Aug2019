...
public class ContactUsPageComponents extends ReusableLibrary {
	...
	public void verifySubmitContactInformation_ValidFileSize() {
		try {
			...
			commonFunctions.clickIfElementPresent(driver.findElement(ContactUsPage.btnUploadFiles), "Button - Upload Files");
		    driver.switchTo()
		            .activeElement()
		            .sendKeys(
		            		System.getProperty("user.dir")+ "\\DummyDataFiles\\25MB File.pdf");
		    Thread.sleep(60000);
			...
			gc.scrollToElement(ContactUsPage.btnSubmit);
			  ...
			  report.updateTestLog("Verify contact us Page is submitted successfully with Valid file size",
			  "User is NOT able to submit the contact Us Page Successfully with Valid file size", Status.FAIL);
			  }
