...
public class CommonFunctions extends ReusableLibrary {
	 ...
	 * 
	 * if (!element.isEnabled()) { report.updateTestLog("Verify if the Element(" +
	 * strObjName + ") is present and Enabled", strObjName + " object is enabled",
	 * Status.FAIL);
	 * 
	 * } else { report.updateTestLog("Verify if the Element(" + strObjName +
